...
describe('calculatePreliminaryEstimate', () => {
  it('derives demolition, labor, and total costs from the area-based material recommendations', () => {
    expect(calculatePreliminaryEstimate([product(2_400_000), product(1_800_000), product(600_000)]))
      .toEqual({
        materialCost: 4_800_000,
        demolitionCost: 580_000,
        laborCost: 1_440_000,
        totalCost: 6_820_000,
        estimateMin: 6_140_000,
        estimateMax: 7_500_000,
      })
  })
})
