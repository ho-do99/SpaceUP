...
export interface QuoteItemInput { category: string; description?: string; quantity?: number; measurementUnit?: string; unitPrice?: number; amount: number }
export interface QuoteInput { requestId: number; title?: string; startDate?: string; durationDays?: number; floorAreaM2?: number; wallpaperAreaM2?: number; lightingQuantity?: number; ceilingHeightM?: number; roomCount?: number; bathroomCount?: number; siteCondition?: string; materialCost?: number; laborCost?: number; vat?: number; discount?: number; detailContent?: string; items: QuoteItemInput[] }
export type QuoteStatus = 'DRAFT' | 'SUBMITTED' | 'ACCEPTED' | 'REJECTED'
export type QuotePhase = 'PRELIMINARY' | 'FINAL'
export interface QuoteResponse { id: number; requestId: number; contractorId: number; contractorName: string; title?: string | null; startDate?: string | null; durationDays?: number | null; floorAreaM2?: number | null; wallpaperAreaM2?: number | null; lightingQuantity?: number | null; ceilingHeightM?: number | null; roomCount?: number | null; bathroomCount?: number | null; siteCondition?: string | null; materialCost?: number | null; laborCost?: number | null; vat?: number | null; discount?: number | null; detailContent?: string | null; totalAmount: number; status: QuoteStatus; phase: QuotePhase; validUntil?: string | null; revisionRequestNote?: string | null; revisionCount: number; createdAt?: string | null; items: QuoteItemInput[] }
