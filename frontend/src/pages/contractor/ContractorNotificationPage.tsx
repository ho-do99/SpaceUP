...
export default function ContractorNotificationPage() {
  ...
  const { notifications, markNotificationRead, markAllNotificationsRead } = useContractorPortalFlow()
  ...
  const openNotification = (notification: ContractorNotification) => { markNotificationRead(notification.notificationId); navigate(notification.destination) }
