...
export default function ContractorHeaderActions() {
  return (
    <div className="flex shrink-0 items-center gap-3">
      <button type="button" disabled aria-label="채팅 — 2차 개발 예정" className="rounded-md opacity-80 disabled:cursor-not-allowed">
        <img src={messageIcon} alt="" className="h-5 w-5" />
      </button>
      <button type="button" disabled aria-label="마이페이지 — 2차 개발 예정" className="rounded-md opacity-80 disabled:cursor-not-allowed">
        <img src={userIcon} alt="" className="h-5 w-5" />
      </button>
      <button type="button" disabled aria-label="알림 — 2차 개발 예정" className="relative rounded-md opacity-80 disabled:cursor-not-allowed">
